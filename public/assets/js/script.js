...
function themeDark() 
{
    const darktheme = document.querySelector('#check'); 

    if (darktheme.checked) {
        document.querySelector('body').style.backgroundColor = '#18191A';
        document.querySelector('header').style.backgroundColor = '#242526';
        document.querySelector('.user-area-text').style.color = '#fff';
        document.querySelector('.feed-item').style.backgroundColor = '#242526';
